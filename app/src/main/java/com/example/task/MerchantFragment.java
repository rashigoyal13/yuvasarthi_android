...
public class MerchantFragment extends Fragment {
    ...
    CardView doctor,jobs,pg_hostel,travel,education,b2b,daily_needs,food_delivery,home_services;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        doctor=v.findViewById(R.id.cd1);
        doctor.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i=new Intent(getContext(),mer_doctor.class);
                startActivity(i);
            }
        });
        return(v);
